...
import { faArchive, faAt, faBan, faBarcode, faBookReader, faCamera, faChartLine, faCheck, faChevronUp, faChevronDown, faChevronRight, faCircleNotch, faCog, faCompressAlt, faDatabase, faDoorClosed, faDownload, faDharmachakra, faEllipsisV, faEuroSign, faExchangeAlt, faExpandAlt, faFileDownload, faFilter, faGhost, faHome, faInfo, faLevelUpAlt, faListOl, faMinus, faNetworkWired, faPen, faPencilRuler, faShoppingBasket, faPhone, faPlaneArrival, faPlus, faPowerOff, faPrint, faShippingFast, faSignature, faTable, faTimes, faTruck, faTruckLoading, faUndo, faUniversity, faUpload, faUserLock, faUserPlus, faUsers, faUserSecret, faUserTag, faUserTie, faUtensils, faUsersCog, faWarehouse, faWifi, faWrench, faMedkit } from '@fortawesome/free-solid-svg-icons';
